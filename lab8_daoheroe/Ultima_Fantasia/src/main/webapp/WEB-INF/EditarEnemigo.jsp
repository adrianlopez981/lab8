...
<div class="container marketing">
  ...
  <div class="row featurette" style="background-color:#09180380">
    <div class="col-md-7">
      <p></p>
      <center><h1 style="font-weight: 400;font-style: normal; color:#A6D1F0" class="custom-font" class="card-subtitle">E N E M I G O</h1></center>
      <center><p class="card-text" style="font-weight: 400;font-style: normal; color:#DEEFFA90"><small>Editar</small></p></center>
      <p>
      <div class="input-group mb-3">
        <span class="input-group-text" id="basic-addon1">Nombre :</span>
        <input type="text" class="form-control" placeholder="Ingrese Nombre" aria-label="Username" aria-describedby="basic-addon1" value="Dante">
      </div>

      <div class="input-group mb-3">
        <span class="input-group-text">Clase :</span>
        <input type="text" class="form-control" aria-label="Server" value="198">
        <span class="input-group-text">Ataque :</span>
        <input type="text" class="form-control" aria-label="Username" value="87">
        <span class="input-group-text">Experiencia :</span>
        <input type="text" class="form-control" aria-label="Server" value="147">
      </div>

      <div class="input-group mb-3">
        <input type="text" class="form-control" placeholder="Objeto a usar" aria-label="Recipient's username" aria-describedby="basic-addon2" value="Pistola">
        <span class="input-group-text" id="basic-addon2">: Objeto</span>
      </div>
      <div class="input-group mb-3">
        <span class="input-group-text">Probabilidad :</span>
        <input type="text" class="form-control" aria-label="Server" value="0.7" >
    ...
    <div class="col-md-5">
      ...
      <br>
      <br>
      <center><img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="300" height="600" src="1x/diosAzteca_azul.jpg"><rect width="100%" height="100%" src="1x/diosInti.png"></rect></center>
      <center><p class="card-text" style="font-weight: 400;font-style: normal; color:#DEEFFA90"><small>Personaje que representa a los Enemigos</small></p></center>
    </div>
  ...
  <div class="d-grid gap-2 d-md-flex justify-content-md-end">
    <a href="<%=request.getContextPath()%>/MenuEnemigos"><button type="button" class="btn btn-danger">Aceptar >></button></a>
  </div>
</div>
<br>
<br>
