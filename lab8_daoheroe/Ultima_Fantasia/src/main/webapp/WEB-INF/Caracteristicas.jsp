...
<center>
  <div class="card text-bg-dark" style="width: 50rem;">
    ...
    <div class="card-img-overlay">
      <h1 class="card-title" style="font-family:'Luminari';font-weight: 400;font-style: normal; color:#F7E252">C A R A C T E R Í S T I C A S</h1>
      <p class="card-text"><small>Clases de los Enemigos</small></p>
      <form>
        <fieldset disabled>

          <div class="mb-3" style="width: 40rem;">
            <label for="disabledTextInput" class="form-label">Nombre del elemento: </label>
            <input type="text" id="disabledTextInput" class="form-control" placeholder="Dragón">
          </div>
          <div class="mb-3" style="width: 40rem;">
            <label for="disabledTextInput" class="form-label">Porcentaje del daño recibido: </label>
        ...
        <div class="mb-3">
          <label for="disabledTextInput" class="form-label">Debilidad o Fortaleza: </label>
          <div class="progress">
  ...
  <div class="d-grid gap-2 d-md-flex justify-content-md-end">
    <a href="<%=request.getContextPath()%>/clasesEnemigos"><button type="button" class="btn btn-danger"> ← Atrás </button></a>
  </div>
  </div>
  <br>
  <br>
