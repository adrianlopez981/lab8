...
<%@ page import="com.webapphr.model.beans.Hechizos" %>
<%@ page import="java.util.ArrayList" %>

<%
  ArrayList<Hechizos> listaHechizos = (ArrayList <Hechizos>) request.getAttribute("listaHechizo");
%>
            ...
            <tr>
              ...
              <td>
                <div class="btn-group" role="group" aria-label="Basic mixed styles example" style="padding-left: 3rem;">
                  ...
                  <a href="<%=request.getContextPath()%>/MenuHechizos" class="btn btn-success">Eliminar</a>
...
<div class="d-grid gap-2 d-md-flex justify-content-md-end">
  <a href="<%=request.getContextPath()%>/AnadirHechizo"><button type="button" class="btn btn-danger">Añadir >></button></a>
</div>
