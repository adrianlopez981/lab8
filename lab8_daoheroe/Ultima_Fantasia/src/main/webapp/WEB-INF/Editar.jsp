...
<div class="container marketing">
  ...
  <div class="row featurette" style="background-color:#09180380">
    <div class="col-md-7">
      <p></p>
      <center><h1 style="font-weight: 400;font-style: normal; color:#F7E45F" class="custom-font" class="card-subtitle">H é r o e</h1></center>
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" placeholder="Ingrese Nombre" aria-label="Username" aria-describedby="basic-addon1" value="Trevor">
      </div>
      <div class="input-group mb-3">
        <span class="input-group-text" id="basic-addon1">Edad :</span>
        <input type="text" class="form-control" placeholder="Ingrese Nombre" aria-label="Username" aria-describedby="basic-addon1" value="850">
        <span class="input-group-text" id="basic-addon2">Género</span>
        <select class="form-select" aria-label="Default select example">
          <option selected>M - Masculino</option>
          <option value="1">M - Masculino</option>
          <option value="2">F - Femenino</option>
          <option value="3">O - Otros</option>
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" value="Dragón">
      </div>

      <div class="input-group mb-3">
        <span class="input-group-text">Nivel Inicial :</span>
        <input type="text" class="form-control" placeholder="Nivel" aria-label="Username" value="80">
        <span class="input-group-text">Ataque :</span>
        <input type="text" class="form-control" placeholder="Ataque" aria-label="Server" value="15">
      </div>

      <div class="input-group mb-3">
        <input type="text" class="form-control" placeholder="Ingrese Nombre" aria-label="Recipient's username" aria-describedby="basic-addon2" value="Cathy">
        <span class="input-group-text" id="basic-addon2">: Nombre Pareja</span>
      </div>
      <div class="input-group mb-3">
        <span class="input-group-text" id="basic-addon1">Experiencia Inicial :</span>
        <input type="text" class="form-control" placeholder="Ingrese n (Nivel)" aria-label="Username" aria-describedby="basic-addon1">
      </div>
    </div>
    <div class="col-md-5">
      <p></p>
      <br>
      <br>
      <img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" src="1x/diosInti2.png"><rect width="100%" height="100%" src="1x/diosInti.png"></rect>
      <center><p class="card-text" style="font-weight: 400;font-style: normal; color:#FFF3A090"><small>Personaje que representa a los Héroes</small></p></center>
    </div>
  ...
  <div class="d-grid gap-2 d-md-flex justify-content-md-end">
    <a href="<%=request.getContextPath()%>/MenuHeroes"><button type="button" class="btn btn-danger">Aceptar >></button></a>
  </div>
</div>
