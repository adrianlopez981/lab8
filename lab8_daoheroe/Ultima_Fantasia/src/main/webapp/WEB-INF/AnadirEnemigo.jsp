...
<div class="container marketing">
  ...
  <div class="row featurette" style="background-color:#09180380">
    <div class="col-md-7">
      ...
      <center><p class="card-text" style="font-weight: 400;font-style: normal; color:#DEEFFA90"><small>Añadir</small></p></center>
      <p>
      ...
      <div class="input-group mb-3">
        <input type="text" class="form-control" placeholder="Objeto a usar" aria-label="Recipient's username" aria-describedby="basic-addon2">
