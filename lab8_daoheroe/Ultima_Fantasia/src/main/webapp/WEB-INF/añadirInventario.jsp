...
<center>
  <div class="card text-bg-dark" style="width: 50rem;">
    ...
    <div class="card-img-overlay">
      <h2 class="card-title" style="font-family:'Luminari';font-weight: 400;font-style: normal; color:#BCDCB6">INVENTARIO DE OBJETOS</h2>
      <br>
  ...
  <div class="d-grid gap-2 d-md-flex justify-content-md-end">
    <a href="<%=request.getContextPath()%>/MenuHeroes"><button type="button" class="btn btn-danger">Añadir >> </button></a>
  </div>
  </div>
  <br>
  <br>
