...
<div class="container marketing">
  ...
  <div class="row featurette" style="background-color:#09180380">
    <div class="col-md-7">
      ...
      <center><p class="card-text" style="font-weight: 400;font-style: normal; color:#FFF3A090"><small>Añadir</small></p></center>
      <p>
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" placeholder="Ataque" aria-label="Server">
      </div>

      <div class="input-group mb-3">
        <input type="text" class="form-control" placeholder="Ingrese Nombre" aria-label="Recipient's username" aria-describedby="basic-addon2">
      ...
      <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" placeholder="Experiencia" aria-label="Username" aria-describedby="basic-addon1">
      </div>
    </div>
    <div class="col-md-5">
      <p></p>
