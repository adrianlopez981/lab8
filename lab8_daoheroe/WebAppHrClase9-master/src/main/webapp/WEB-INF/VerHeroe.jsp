                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example" style="padding-left: 3rem;">
                                    <a href="EditarHeroe.html" class="btn btn-success" >Editar</a>
                                    <a href="EliminarHeroe.html" class="btn btn-primary">Eliminar</a>
                                    <a href="VerHeroe.html" class="btn btn-success .5;">Ver</a>
                                </div>
