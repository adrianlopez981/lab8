        ...
        <div class="card">
            <div class="card-body" style="background-color:#F2FDE8">
                <div class="p-7 mb-2 bg-primary text-white">
                    <h4 style="text-align: center; color: white; font-family:'Times New Roman', Times, serif; background-color:#6B9D3D" >REPORTE  DE  HÉROES</h4>
                </div>
                <br>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example" style="padding-left: 3rem;">
                                    <a href="<%=request.getContextPath()%>/EditarHeroe" class="btn btn-success" >Editar</a>
                                    <a href="<%=request.getContextPath()%>/EliminarHeroe" class="btn btn-primary">Eliminar</a>
                                    <a href="<%=request.getContextPath()%>/VerHeroe" class="btn btn-success .5;">Ver</a>
                                </div>
