    ...
    <div class="card">
      <div class="card-body" style="background-color:#F2FDE8">
        <div class="p-7 mb-2 bg-primary text-white">
          <h4 style="text-align: center; color: white; font-family:'Times New Roman', Times, serif; background-color:#CF9D55" >CATÁLOGO OBJETOS</h4>
        </div>
        <br>
        ...
        <center>
          <table class="table">
            ...
            <tr>
              <th scope="col">#</th>
              <th scope="col"><button type="button">Nombre Arma</button></th>
              <th scope="col">Efecto/Uso</th>
