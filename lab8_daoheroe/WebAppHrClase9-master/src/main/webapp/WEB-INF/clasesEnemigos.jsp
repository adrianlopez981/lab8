    ...
    <div class="card">
      <div class="card-body" style="background-color:#F2FDE8">
        <div class="p-7 mb-2 bg-primary text-white">
          <h4 style="text-align: center; color: white; font-family:'Times New Roman', Times, serif; background-color:#529EAB" >CLASES DE LOS ENEMIGOS</h4>
        </div>
        <br>
        ...
        <center>
          <table class="table">
            ...
            <tr>
              ...
              <td>Dragon</td>
              <td>
                <a href="<%=request.getContextPath()%>/Caracteristicas" class="btn btn-success" >Caracteristicas</a>
              </td>
            </tr>
            <tr>
              <th scope="row">2</th>
