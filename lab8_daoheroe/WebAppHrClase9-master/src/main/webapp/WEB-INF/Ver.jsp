...
<center>
  <div class="card text-bg-dark" style="width: 50rem;">
    ...
    <div class="card-img-overlay">
      ...
      <div class="card" style="width: 35rem; background-color:#B1B8B090">
        ...
        <div class="card-body">
          <table class="table" style="width: 20rem;">
            ...
            <tbody>
            <tr>
              <td><p style="color:#FFFFFF">Arco Clásico</p></td>
      ...
      <div class="btn-group" role="group" aria-label="Basic example">
        <a href="añadirInventario.html"><button type="button" class="btn btn-success">Añadir</button></a>
        <a href="editarInventario.html"><button type="button" class="btn btn-success">Editar</button></a>
        <a href="Ver.html"><button type="button" class="btn btn-success">Eliminar</button></a>
      </div>
    </div>
  ...
  <div class="d-grid gap-2 d-md-flex justify-content-md-end">
    <a href="MenuHeroes.html"><button type="button" class="btn btn-danger"> ← Atrás </button></a>
  </div>
  </div>
  <br>
  <br>
