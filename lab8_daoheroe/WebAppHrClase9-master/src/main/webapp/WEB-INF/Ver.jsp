...
<center>
  <div class="card text-bg-dark" style="width: 50rem;">
    ...
    <div class="card-img-overlay">
      ...
      <div class="btn-group" role="group" aria-label="Basic example">
        <a href="<%=request.getContextPath()%>/añadirInventario"><button type="button" class="btn btn-success">Añadir</button></a>
  ...
  <div class="d-grid gap-2 d-md-flex justify-content-md-end">
    <a href="<%=request.getContextPath()%>/MenuHeroes"><button type="button" class="btn btn-danger"> ← Atrás </button></a>
  </div>
  </div>
  <br>
  <br>
