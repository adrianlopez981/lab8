...
<center>
  <div class="card text-bg-dark" style="width: 50rem;">
    <img src="1x/piedraFondo.jpg" class="card-img" alt="Fondo Piedra">
    <div class="card-img-overlay" >
      <h2 class="card-title" style="font-family:'Luminari';font-weight: 400;font-style: normal; color:#77E561">INVENTARIO DE OBJETOS</h2>
      <br>
      <fieldset disabled="">
        <div class="input-group mb-3" style="width: 40rem;">
          <span class="input-group-text" id="basic-addon1">Nombre :</span>
          <input type="text" class="form-control" placeholder="Ingrese Nombre" aria-label="Username" aria-describedby="basic-addon1" value="Arco Clásico">
          <span class="input-group-text">Efecto/uso:</span>
          <input type="text" class="form-control" placeholder="Nivel" aria-label="Username" value="80">
        </div>

        <div class="input-group mb-3" style="width: 40rem;">
          <span class="input-group-text">Peso:</span>
          <input type="text" class="form-control" placeholder="Nivel" aria-label="Username" value="1.80 KG">
        </div>
      </fieldset>
      <div class="input-group mb-3" style="width: 20rem;">
        <span class="input-group-text">Cantidad de Objetos :</span>
        <input type="text" class="form-control" placeholder="Ataque" aria-label="Server" value="15">
      </div>

      <img src="1x/armas.png"  width="630 px" height="180 px">
    </div>

  </div>
  <hr class="featurette-divider">
  <div class="d-grid gap-2 d-md-flex justify-content-md-end">
    <a href="<%=request.getContextPath()%>/MenuHeroes"><button type="button" class="btn btn-danger"> Guardar </button></a>
  </div>
  </div>
  <br>
  <br>
